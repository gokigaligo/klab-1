...
<?php
    if (isset($_FILES['product_pic'])) {
        ...
        $update="update products set pic='".$product_pic."' where id='".$editid."'";
...
<?php include("topheader.php"); ?>
        ...
        <div id="content" class="content">
            ...
            <!-- begin page-header -->
            <h1 class="page-header">Edit  - <?php echo'Picture of '.$productname.''; ?></h1>
            <!-- end page-header -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Edit  - <?php echo'Picture of '.$productname.''; ?></h4>
                        </div>
                                ...
                                <div class="table table-responsive">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>01</td>
                                                <td><input type="text" readonly="" value="<?php echo $productname ;?>"></td>
                                                <td><input value="<?php echo $product_pic;?>" required type="file" name="product_pic" class="form-control"></td>
