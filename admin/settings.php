...
<?php include("topheader.php"); ?> <?php
    ...
    if (isset($_SESSION['klabusername'])) {
        ...
        if ($usercategory == 'standard') {
            header("location: settingstandard");
        }
    }
...
?>
                ...
                <div class="vertical-box-column width-250">
                    ...
                    <div class="wrapper">
                        ...
                        <ul class="nav nav-pills nav-stacked nav-sm">
                            <li class="active">
                                <a href="javascript: void();" data-toggle="modal" data-target="#modal-message"><i class="fa fa-cog fa-fw m-r-5"></i> User Control <span class="badge pull-right">
                                <?php
                                    include("../db.php");
                                    $sqlselect = $con ->query("SELECT * FROM users WHERE category != 'super admin'");
                                    $sqlcount = mysqli_num_rows($sqlselect);
                                    echo number_format($sqlcount);
                                ?>  </span></a>
                            </li>
                            <li class="active">
                                <a href="javascript: void();" data-toggle="modal" data-target="#Delivery"><i class="fa fa-cog fa-fw m-r-5"></i> Delivery Settings</a>
                            </li>
                            <li class="active">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <p>You manage onother users by Add , delete and disable them</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                    include("../db.php");
                                    $sqlFetchuser = $con ->query("SELECT * FROM users WHERE category != 'super admin' ORDER BY id DESC");
                                    $n = 0;
                                     while ($row = mysqli_fetch_array($sqlFetchuser)) {
                                        ...
                                        echo '<tr class="odd gradeX">
                                            ...
                                            <td class="actions">
                                                <a href="?delete='.$row['id'].'& pic='.$row['profile'].'">
                            ...
                            <table class="table table-responsive table table-condensed table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <form action="settings" method="post" enctype="multipart/form-data">
                                        ...
                                        <td><input type="tel" name="usr_phone" class="form-control" required></td>
    ...
    <!-- Modal -->
    <div class="modal modal-message fade" id="Delivery" tabindex="0" role="dialog" aria-labelledb.phpy="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-shopping-cart"></i>Delivery</h4>
                    <p>You can change product delivery time and delivery fees</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                    include("../db.php");
                                    $sqlFetchuser = $con ->query("SELECT * FROM users WHERE name='$name' AND password='$password' LIMIT 1");
                                    $n = 0;
                                     while ($row = mysqli_fetch_array($sqlFetchuser)) {
                                        $productId = $row['id'];
                                        echo '<tr class="odd gradeX">
