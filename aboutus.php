								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											<li><a href="index-2"><img src="img/nav-menu/nav1.jpg" class="img-responsive" alt="" /> Home</a></li>
														...
														<div class="row">
															<div class="col-md-4 col-sm-6">
																...
																<div class="menu-item">
																	...
																	<!-- Button -->
																	<a href="menu" class="btn btn-danger btn-xs">View Menu</a>
																</div>
															</div>
															<div class="col-md-4 col-sm-6">
																<!-- Menu Item -->
											...
											<li class="dropdown visible-xs">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="menu">Non Vegetarian</a></li>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu">
													<li><a href="items">Shopping</a></li>
													<li><a href="item-single">Order Now</a></li>
													<li><a href="checkout">Checkout</a></li>
													<li><a href="reserve-seats">Reservation</a></li>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="0-base">Blank Page</a></li>
													<li><a href="blog">Blog</a></li>
													<li><a href="blog-single">Blog Single</a></li>
													<li><a href="components">Components</a></li>
													<li><a href="general">General</a></li>
													<li><a href="nutrition-info">Nutrition Info</a></li>
													<li><a href="recipe">Recipes</a></li>
												</ul>
											</li>
											<li><a href="aboutus"><img src="img/nav-menu/nav6.jpg" class="img-responsive" alt="" /> About</a></li>
										</ul>
									</div><!-- /.navbar-collapse -->
								</div><!-- /.container-fluid -->
							</nav>
