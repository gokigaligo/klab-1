					...
					<div class="container">
						...
						<div class="shopping-content">
							...
							<?php
								...
								$sqlAll = $con->query("SELECT * FROM products WHERE status = 'Active' LIMIT $start,$record_per_page");
									...
									echo'
										<div style="max-height: 370px; min-height: 370px;" class="col-md-3 col-sm-6">
											...
											<div style="max-height: 350px; min-height: 350px;" class="shopping-item">
												...
												<div class="clearfix"></div>
												<!-- Paragraph -->
												<p>For kLab Member, price not this above, the price
												is <strong>'.number_format($row['price_member']).' FRW</strong></p>
												<!-- Buy now button -->
							...
							<div class="shopping-pagination">
								<ul class="pagination">
									<?php
										...
										$sql = $con ->query("SELECT * FROM products WHERE status='Active'");
										$compter_record = mysqli_num_rows($sql);
										$total_page = ceil($compter_record/$record_per_page);
